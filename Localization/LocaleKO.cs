            ...
            Dictionary<string, int> indexCounts)
        {
            ...
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.CancelLateBoarders)),
                    "**BETA**\n" +
                    "바닐라 출발 시간 이후에도 <준비 안 됨> 상태인 늦은 승객은 그 차량을 놓칠 수 있습니다.\n" +
                    "참고: 지금은 혼자 이동하는 늦은 시민만 스킵하므로, 함께 이동하는 그룹/가족은 <스킵하지 않으며> 바닐라처럼 여전히 지연을 일으킬 수 있습니다.\n" +
                    "그룹 여행자는 많은 혼자 이동 승객에 비해 적은 수입니다.\n" +
                    "스킵된 늦은 시민은 삭제되지 않으며, 이후 바닐라 시스템이 계속 배정합니다."
                },
